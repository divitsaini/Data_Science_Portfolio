...
Original file is located at
    https://colab.research.google.com/drive/1q9f_EvoOA7gm2jSIOMLcdTTSC1ZIS2CH
"""
...
def main():
    ...
    while True:
        ...
        if len(lmList) != 0:
            print(lmList[14])
            cv2.circle(img, (lmList[13][1], lmList[13][2]), 15, (0, 0, 255), cv2.FILLED) #left elbow highlight
        cTime = time.time()
        fps = 1 / (cTime - pTime)
        pTime = cTime
